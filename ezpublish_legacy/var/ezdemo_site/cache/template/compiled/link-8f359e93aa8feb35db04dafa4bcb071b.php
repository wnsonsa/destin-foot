...
$oldSetArray_788eb265eac37c7680e72a29cdf56086 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '" />
<link rel="Search" href="/fre/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_788eb265eac37c7680e72a29cdf56086;
$tpl->Level--;
?>

...
$oldSetArray_688b62fff96b22c6bdfc31c6a2ef2208 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/fre/shop/basket" title="Panier d\'achats">Panier d\'achats</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/fre/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/fre/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/fre/user/register" title="S\'inscrire">S\'inscrire</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/fre/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/fre/user/forgotpassword" class="forgot-password">Mot de passe oublié ?</a>
...
$setArray = $oldSetArray_688b62fff96b22c6bdfc31c6a2ef2208;
$tpl->Level--;
?>
